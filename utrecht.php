...
$page_title = 'Orgineel kado: Utrecht';
...
echo "<h1><center>Thema: Utrecht</center></h1>";
...
$query=mysql_query("select * from Product WHERE `Provincie`='Utrecht' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Utrecht'"));
