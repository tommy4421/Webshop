...
$page_title = 'Orgineel kado: Zuid-Holland';
...
echo "<h1><center>Thema: Zuid-Holland</center></h1>";
...
$query=mysql_query("select * from Product WHERE `Provincie`='Zuid-Holland' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Zuid-Holland'"));
