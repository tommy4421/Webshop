...
$page_title = 'Orgineel kado: Gelderland';
...
echo "<h1><center>Thema: Gelderland</center></h1>";
...
$query=mysql_query("select * from Product WHERE `Provincie`='Gelderland' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Gelderland'"));
