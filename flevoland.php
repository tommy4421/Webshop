...
$page_title = 'Orgineel kado: Flevoland';
...
echo "<h1><center>Thema: Flevoland</center></h1>";
...
$query=mysql_query("select * from Product WHERE `Provincie`='Flevoland' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Flevoland'"));
