...
$page_title = 'Orgineel kado: Friesland';
...
$query=mysql_query("select * from Product WHERE `Provincie`='Friesland' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Friesland'"));
