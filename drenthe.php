...
$page_title = 'Orgineel kado: Drenthe';
...
echo "<h1><center>Thema: Drenthe</center></h1>";
...
$query=mysql_query("select * from Product WHERE `Provincie`='Drenthe' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Drenthe'"));
