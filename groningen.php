...
echo "<h1><center>Thema: Groningen</center></h1>";
...
$query=mysql_query("select * from Product WHERE `Provincie`='Groningen' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Groningen'"));
