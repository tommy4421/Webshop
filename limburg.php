...
$page_title = 'Orgineel kado: Limburg';
...
echo "<h1><center>Thema: Limburg</center></h1>";
...
$query=mysql_query("select * from Product WHERE `Provincie`='Limburg' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Limburg'"));
