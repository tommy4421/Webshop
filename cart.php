...
if (empty($_SESSION['cart'])) {
	...
	<thead>
    <tr>
        <th>Productnaam &emsp;</th>
        <th>Hoeveelheid &emsp;</th>
        <th>Prijs p/s &emsp;</th>
        <th>Totaal</th>
        <th>&nbsp;</th> 
    </tr>
	</thead>
    ...
    foreach($cart as $products) {
      ...
      if (strlen(trim($product[1])) <> 0) {
		  ...
		  echo "      &emsp;<input type=\"text\" name=\"hoeveelheid_".$i."\" value=\"".$product[1]."\" size=\"2\" maxlength=\"2\"/></td>\n";
		  ...
		  echo "  <td><a href=\"javascript:removeItem(".$i.")\">&emsp;&emsp;<img src=\"images\delete.png\"/></a></td>\n"; // Verwijder, mooi plaatje van prullebak ofzo
		  echo "</tr>\n</tbody>";
		  // Total
  ...
  <ul>
		...
		<li><a href=<?php\"javascript:history.go(-1)\?>">Verder winkelen</a></li>
	</ul>	
  </p>
  <?php
}
