	...
	if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
		...
		$idi2 = $_POST['productid'];
			...
			else
			{
				...
				$sql = "UPDATE `Product` SET `Naam`='$naam2', `Beschrijving`='$beschrijving2', `Provincie`='$provincie2', `Voorraad_aantal`='$voorraad2', `Prijs_perstuk`='$prijs2', `Leverbaar`='$leverbaar2' WHERE `ProductID`='$idi2'";
