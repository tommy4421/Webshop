...
$page_title = 'Orgineel kado: Overijssel';
...
echo "<h1><center>Thema: Overijssel</center></h1>";
...
$query=mysql_query("select * from Product WHERE `Provincie`='Overijssel' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Overijssel'"));
