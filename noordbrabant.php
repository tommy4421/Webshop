...
$page_title = 'Orgineel kado: Brabant';
...
echo "<h1><center>Thema: Noord-Brabant</center></h1>";
...
$query=mysql_query("select * from Product WHERE `Provincie`='Noord-Brabant' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Noord-Brabant'"));
