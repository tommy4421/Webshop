...
$page_title = 'Orgineel kado: Zeeland';
...
echo "<h1><center>Thema: Zeeland</center></h1>";
...
$query=mysql_query("select * from Product WHERE `Provincie`='Zeeland' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Zeeland'"));
