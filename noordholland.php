...
$page_title = 'Orgineel kado: Noord-Holland';
...
echo "<h1><center>Thema: Noord-Holland</center></h1>";
...
$query=mysql_query("select * from Product WHERE `Provincie`='Noord-Holland' LIMIT $start, $limit");
echo "<ul>";
...
$rows=mysql_num_rows(mysql_query("select * from Product WHERE `Provincie`='Noord-Holland'"));
